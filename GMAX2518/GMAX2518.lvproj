   ...
   <CLIPDeclarationCategory name="FlexRIO-IOModule">
      <CLIPDeclaration name="NI 6581 Channel">
         ...
         <InterfaceList>
			...
			<Property Name="niFpga_TopLevelVIID" Type="Path">/C/LabView_PRJ/GMAX2518/Target_2518.vi</Property>
...
&lt;/Array&gt;
Local_Supply_SelectArbitrationForOutputData=NeverArbitrate;NumberOfSyncRegistersForOutputData=1;resource=/IO Module/SignalList/Local_Supply_Select;0;WriteMethodType=U8PXI-7953R/RioClk40/falsefalseFLEXRIO_IO_MODELNI_6581FPGA_EXECUTION_MODEFPGA_TARGETFPGA_TARGET_CLASSPXI_7953RFPGA_TARGET_FAMILYVIRTEX5TARGET_TYPEFPGA/[rSeriesConfig.Begin][rSeriesConfig.End]READActual Number of Elements=256;ReadArbs=1;WriteArbs=1;Implementation=2;DataType=1000800000000001000940050002553800000100000000000000;InitDataHash=;DRAM Selection=DramBank0;DRAM Max Outstanding Requests=64;DRAM Include Byte Enables=FALSE;DRAM Grant Time=50;Interface Configuration=Read A-Write B;Multiple Clock Domains=TRUE;Memory Latency=2T_TO_H"ControlLogic=0;NumberOfElements=511;Type=2;ReadArbs=Arbitrate if Multiple Requestors Only;ElementsPerRead=1;WriteArbs=Arbitrate if Multiple Requestors Only;ElementsPerWrite=1;Implementation=2;T_TO_H;DataType=1000800000000001000940050002553800000100000000000000;DisableOnOverflowUnderflow=FALSE"WRITEActual Number of Elements=256;ReadArbs=1;WriteArbs=1;Implementation=2;DataType=1000800000000001000940050002553800000100000000000000;InitDataHash=A485F926711A440179DE72170DF1C4A7;DRAM Selection=DramBank0;DRAM Max Outstanding Requests=64;DRAM Include Byte Enables=FALSE;DRAM Grant Time=50;Interface Configuration=Read A-Write B;Multiple Clock Domains=TRUE;Memory Latency=2</Property>
				<Property Name="NI.LV.FPGA.InterfaceBitfile" Type="Str">C:\LabView_PRJ\GMAX2518\FPGA Bitfiles\GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx</Property>
			</Item>
			<Item Name="2372000 64-bit" Type="FPGA Memory Block">
				...
				<Property Name="NI.LV.FPGA.CompileConfigString" Type="Str">Actual Number of Elements=2490368;ReadArbs=1;WriteArbs=1;Implementation=3;DataType=100080000000000100094008000355363400010000000000000000000000000000;InitDataHash=;DRAM Selection=DramBank0;DRAM Max Outstanding Requests=64;DRAM Include Byte Enables=FALSE;DRAM Grant Time=50;Interface Configuration=Read A-Write B;Multiple Clock Domains=FALSE;Memory Latency=2</Property>
				<Property Name="NI.LV.FPGA.MEMORY.ActualNumberOfElements" Type="UInt">2490368</Property>
				...
				<Property Name="NI.LV.FPGA.MEMORY.RequestedNumberOfElements" Type="UInt">2372000</Property>
				<Property Name="NI.LV.FPGA.MEMORY.Type" Type="UInt">3</Property>
				<Property Name="NI.LV.FPGA.ScriptConfigString" Type="Str">Actual Number of Elements=2490368;ReadArbs=1;WriteArbs=1;Implementation=3;DataType=100080000000000100094008000355363400010000000000000000000000000000;InitDataHash=;DRAM Selection=DramBank0;DRAM Max Outstanding Requests=64;DRAM Include Byte Enables=FALSE;DRAM Grant Time=50;Interface Configuration=Read A-Write B;Multiple Clock Domains=FALSE;Memory Latency=2Persist Memory ValuesFALSE;</Property>
			...
			<Item Name="WRITE" Type="FPGA Memory Block">
				...
				<Property Name="NI.LV.FPGA.MEMORY.InitData" Type="Str"></Property>
			...
			<Item Name="FRAME" Type="FPGA FIFO">
				...
				<Property Name="Number Of Elements Per Read" Type="UInt">1</Property>
				<Property Name="Number Of Elements Per Write" Type="UInt">1</Property>
				<Property Name="Requested Number of Elements" Type="UInt">30003</Property>
				<Property Name="Type" Type="UInt">2</Property>
				<Property Name="Type Descriptor" Type="Str">100080000000000100094008000355363400010000000000000000000000000000</Property>
			</Item>
			<Item Name="40 MHz Onboard Clock" Type="FPGA Base Clock">
				...
				<Item Name="20MHz" Type="FPGA Derived Clock">
					<Property Name="FPGA.PersistentID" Type="Str">{68EC6409-7883-45EA-B4EF-E435FC9D48C9}</Property>
			...
			<Item Name="DRAM Bank 0" Type="FPGA Component Level IP">
				<Property Name="FPGA.PersistentID" Type="Str">{05BA7826-8696-45C1-8297-A3B895FE47EB}</Property>
...
&lt;/Array&gt;
   ...
   <Value>/IO Module/SignalList/Local_Supply_Select</Value>
			...
			<Item Name="Build Specifications" Type="Build">
				<Item Name="Target_2518" Type="{F4C5E96F-7410-48A5-BB87-3559BC9B167F}">
					<Property Name="AllowEnableRemoval" Type="Bool">false</Property>
					<Property Name="BuildSpecDecription" Type="Str"></Property>
					<Property Name="BuildSpecName" Type="Str">Target_2518</Property>
					<Property Name="Comp.BitfileName" Type="Str">GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx</Property>
					...
					<Property Name="NI.LV.FPGA.LastCompiledBitfilePath" Type="Path">/C/LabView_PRJ/GMAX2518/FPGA Bitfiles/GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx</Property>
					<Property Name="NI.LV.FPGA.LastCompiledBitfilePathRelativeToProject" Type="Path">FPGA Bitfiles/GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx</Property>
					<Property Name="ProjectPath" Type="Path">/C/LabView_PRJ/GMAX2518/GMAX2518.lvproj</Property>
					<Property Name="RelativePath" Type="Bool">true</Property>
					<Property Name="RunWhenLoaded" Type="Bool">false</Property>
					<Property Name="SupportDownload" Type="Bool">true</Property>
					<Property Name="SupportResourceEstimation" Type="Bool">true</Property>
					<Property Name="TargetName" Type="Str">FPGA Target</Property>
					<Property Name="TopLevelVI" Type="Ref">/My Computer/FPGA Target/Target_2518.vi</Property>
				</Item>
			</Item>
		</Item>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx" Type="Document" URL="../FPGA Bitfiles/GMAX2518_FPGATarget_Target2518_wpKPnY-EnHw.lvbitx"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
